...
DEFINE_bool(plot_gps_l1_tracking_cuda_test, false, "Plots results of GpsL1CADllPllTrackingCUDATest with gnuplot");


// ######## GNURADIO BLOCK MESSAGE RECEVER #########
class GpsL1CADllPllTrackingCUDATest_msg_rx;

typedef boost::shared_ptr<GpsL1CADllPllTrackingCUDATest_msg_rx> GpsL1CADllPllTrackingCUDATest_msg_rx_sptr;

GpsL1CADllPllTrackingCUDATest_msg_rx_sptr GpsL1CADllPllTrackingCUDATest_msg_rx_make();

class GpsL1CADllPllTrackingCUDATest_msg_rx : public gr::block
{
private:
    friend GpsL1CADllPllTrackingCUDATest_msg_rx_sptr GpsL1CADllPllTrackingCUDATest_msg_rx_make();
    void msg_handler_events(pmt::pmt_t msg);
    GpsL1CADllPllTrackingCUDATest_msg_rx();

public:
    int rx_message;
    ~GpsL1CADllPllTrackingCUDATest_msg_rx();  //!< Default destructor
};


GpsL1CADllPllTrackingCUDATest_msg_rx_sptr GpsL1CADllPllTrackingCUDATest_msg_rx_make()
{
    return GpsL1CADllPllTrackingCUDATest_msg_rx_sptr(new GpsL1CADllPllTrackingCUDATest_msg_rx());
}


void GpsL1CADllPllTrackingCUDATest_msg_rx::msg_handler_events(pmt::pmt_t msg)
{
    try
    {
...
GpsL1CADllPllTrackingCUDATest_msg_rx::GpsL1CADllPllTrackingCUDATest_msg_rx() : gr::block("GpsL1CADllPllTrackingCUDATest_msg_rx", gr::io_signature::make(0, 0, 0), gr::io_signature::make(0, 0, 0))
{
    this->message_port_register_in(pmt::mp("events"));
    this->set_msg_handler(pmt::mp("events"), boost::bind(&GpsL1CADllPllTrackingCUDATest_msg_rx::msg_handler_events, this, _1));
    rx_message = 0;
}


GpsL1CADllPllTrackingCUDATest_msg_rx::~GpsL1CADllPllTrackingCUDATest_msg_rx()
{
}
...
class GpsL1CADllPllTrackingCUDATest : public ::testing::Test
{
public:
    ...
    std::string implementation = "GPS_L1_CA_DLL_PLL_Tracking_CUDA";  //"GPS_L1_CA_DLL_PLL_C_Aid_Tracking";
...
int GpsL1CADllPllTrackingCUDATest::configure_generator()
{
...
int GpsL1CADllPllTrackingCUDATest::generate_signal()
{
    int child_status;
...
void GpsL1CADllPllTrackingCUDATest::configure_receiver()
{
...
void GpsL1CADllPllTrackingCUDATest::check_results_doppler(arma::vec& true_time_s,
                                                      arma::vec& true_value,
                                                      arma::vec& meas_time_s,
                                                      arma::vec& meas_value)
{
...
void GpsL1CADllPllTrackingCUDATest::check_results_acc_carrier_phase(arma::vec& true_time_s,
                                                                arma::vec& true_value,
                                                                arma::vec& meas_time_s,
                                                                arma::vec& meas_value)
{
...
void GpsL1CADllPllTrackingCUDATest::check_results_codephase(arma::vec& true_time_s,
                                                        arma::vec& true_value,
                                                        arma::vec& meas_time_s,
                                                        arma::vec& meas_value)
{
...
TEST_F(GpsL1CADllPllTrackingCUDATest, ValidationOfResults)
{
    ...
    boost::shared_ptr<GpsL1CADllPllTrackingCUDATest_msg_rx> msg_rx = GpsL1CADllPllTrackingCUDATest_msg_rx_make();

    // load acquisition data based on the first epoch of the true observations
    ASSERT_EQ(true_obs_data.read_binary_obs(), true) << "Failure reading true tracking dump file." << std::endl << "Maybe sat PRN #" + std::to_string(FLAGS_test_satellite_PRN) + " is not available?";
    ...
    if (FLAGS_plot_gps_l1_tracking_cuda_test == true)
    {
        const std::string gnuplot_executable(FLAGS_gnuplot_executable);
        if (gnuplot_executable.empty())
        {
            std::cout << "WARNING: Although the flag plot_gps_l1_tracking_cuda_test has been set to TRUE," << std::endl;
