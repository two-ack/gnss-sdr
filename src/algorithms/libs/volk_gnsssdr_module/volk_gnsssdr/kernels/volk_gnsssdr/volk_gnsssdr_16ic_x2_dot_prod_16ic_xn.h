...
static inline void volk_gnsssdr_16ic_x2_dot_prod_16ic_xn_neon64(lv_16sc_t* result, const lv_16sc_t* in_common, const lv_16sc_t** in_a, int num_a_vectors, unsigned int num_points)
{
    lv_16sc_t dotProduct = lv_cmake(0, 0);
    int n_vec;
    unsigned int index;
...
static inline void volk_gnsssdr_16ic_x2_dot_prod_16ic_xn_neon64_vma(lv_16sc_t* result, const lv_16sc_t* in_common, const lv_16sc_t** in_a, int num_a_vectors, unsigned int num_points)
{
    lv_16sc_t dotProduct = lv_cmake(0, 0);
...
static inline void volk_gnsssdr_16ic_x2_dot_prod_16ic_xn_neon64_optvma(lv_16sc_t* result, const lv_16sc_t* in_common, const lv_16sc_t** in_a, int num_a_vectors, unsigned int num_points)
{
    lv_16sc_t dotProduct = lv_cmake(0, 0);
