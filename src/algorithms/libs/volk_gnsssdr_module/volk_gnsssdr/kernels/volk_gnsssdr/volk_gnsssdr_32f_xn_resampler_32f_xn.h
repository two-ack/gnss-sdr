...
static inline void volk_gnsssdr_32f_xn_resampler_32f_xn_neon64(float** result, const float* local_code, float rem_code_phase_chips, float code_phase_step_chips, float* shifts_chips, unsigned int code_length_chips, int num_out_vectors, unsigned int num_points)
{
    float** _result = result;
    const unsigned int neon_iters = num_points / 4;
    int current_correlator_tap;
