...
static inline void volk_gnsssdr_16ic_x2_rotator_dotprodxnpuppet_16ic_neon64(lv_16sc_t* result, const lv_16sc_t* local_code, const lv_16sc_t* in, unsigned int num_points)
{
    // phases must be normalized. Phase rotator expects a complex exponential input!
    float rem_carrier_phase_in_rad = 0.345;
    float phase_step_rad = 0.1;
    ...
    volk_gnsssdr_16ic_x2_rotator_dot_prod_16ic_xn_neon64(result, local_code, phase_inc[0], phase, (const lv_16sc_t**)in_a, num_a_vectors, num_points);
...
#ifdef LV_HAVE_NEON64
static inline void volk_gnsssdr_16ic_x2_rotator_dotprodxnpuppet_16ic_neon64_vma(lv_16sc_t* result, const lv_16sc_t* local_code, const lv_16sc_t* in, unsigned int num_points)
{
    // phases must be normalized. Phase rotator expects a complex exponential input!
    float rem_carrier_phase_in_rad = 0.345;
    float phase_step_rad = 0.1;
    ...
    volk_gnsssdr_16ic_x2_rotator_dot_prod_16ic_xn_neon64_vma(result, local_code, phase_inc[0], phase, (const lv_16sc_t**)in_a, num_a_vectors, num_points);
