...
static inline void volk_gnsssdr_16ic_x2_dotprodxnpuppet_16ic_neon64(lv_16sc_t* result, const lv_16sc_t* local_code, const lv_16sc_t* in, unsigned int num_points)
{
    int num_a_vectors = 3;
    lv_16sc_t** in_a = (lv_16sc_t**)volk_gnsssdr_malloc(sizeof(lv_16sc_t*) * num_a_vectors, volk_gnsssdr_get_alignment());
    unsigned int n;
    ...
    volk_gnsssdr_16ic_x2_dot_prod_16ic_xn_neon64(result, local_code, (const lv_16sc_t**)in_a, num_a_vectors, num_points);
...
static inline void volk_gnsssdr_16ic_x2_dotprodxnpuppet_16ic_neon64_vma(lv_16sc_t* result, const lv_16sc_t* local_code, const lv_16sc_t* in, unsigned int num_points)
{
    int num_a_vectors = 3;
    lv_16sc_t** in_a = (lv_16sc_t**)volk_gnsssdr_malloc(sizeof(lv_16sc_t*) * num_a_vectors, volk_gnsssdr_get_alignment());
    unsigned int n;
    ...
    volk_gnsssdr_16ic_x2_dot_prod_16ic_xn_neon64_vma(result, local_code, (const lv_16sc_t**)in_a, num_a_vectors, num_points);
...
static inline void volk_gnsssdr_16ic_x2_dotprodxnpuppet_16ic_neon64_optvma(lv_16sc_t* result, const lv_16sc_t* local_code, const lv_16sc_t* in, unsigned int num_points)
{
    int num_a_vectors = 3;
    lv_16sc_t** in_a = (lv_16sc_t**)volk_gnsssdr_malloc(sizeof(lv_16sc_t*) * num_a_vectors, volk_gnsssdr_get_alignment());
    unsigned int n;
    ...
    volk_gnsssdr_16ic_x2_dot_prod_16ic_xn_neon64_optvma(result, local_code, (const lv_16sc_t**)in_a, num_a_vectors, num_points);
