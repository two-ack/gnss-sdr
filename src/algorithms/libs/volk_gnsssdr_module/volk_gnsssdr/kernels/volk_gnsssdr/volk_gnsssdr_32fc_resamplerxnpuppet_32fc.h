...
static inline void volk_gnsssdr_32fc_resamplerxnpuppet_32fc_neon64(lv_32fc_t* result, const lv_32fc_t* local_code, unsigned int num_points)
{
    int code_length_chips = 2046;
    float code_phase_step_chips = ((float)(code_length_chips) + 0.1) / ((float)num_points);
    int num_out_vectors = 3;
    ...
    volk_gnsssdr_32fc_xn_resampler_32fc_xn_neon64(result_aux, local_code, rem_code_phase_chips, code_phase_step_chips, shifts_chips, code_length_chips, num_out_vectors, num_points);
