...
static inline void volk_gnsssdr_32fc_x2_rotator_dotprodxnpuppet_32fc_neon64(lv_32fc_t* result, const lv_32fc_t* local_code, const lv_32fc_t* in, unsigned int num_points)
{
    // phases must be normalized. Phase rotator expects a complex exponential input!
    float rem_carrier_phase_in_rad = 0.25;
    float phase_step_rad = 0.1;
    ...
    volk_gnsssdr_32fc_x2_rotator_dot_prod_32fc_xn_neon64(result, local_code, phase_inc[0], phase, (const lv_32fc_t**)in_a, num_a_vectors, num_points);
